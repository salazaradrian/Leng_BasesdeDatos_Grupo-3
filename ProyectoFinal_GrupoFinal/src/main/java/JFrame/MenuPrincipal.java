...
public class MenuPrincipal extends JFrame {
    ...
    public MenuPrincipal() {
        ...
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLocationRelativeTo(null);
        setLayout(null); // Usamos layout manual para posicionar sobre la imagen

        // Imagen de fondo
        ImageIcon fondo = new ImageIcon("src/imagenes/fondo.jpg"); // Ajusta la ruta según tu proyecto
        ...
        // Agregar componentes
        add(panelBotones);
        add(fondoLabel); // Se agrega al final para que quede al fondo
